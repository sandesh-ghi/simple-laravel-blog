...
//});
//frontend
Route::get('/',[\App\Http\Controllers\Frontend\HomeContreller::class,'homePage'])->name('frontend.home');
Route::get('/post/{slug}',[\App\Http\Controllers\Frontend\HomeContreller::class,'postDetail'])->name('frontend.post_detail');
Route::get('/comment/{slug}',[\App\Http\Controllers\Frontend\HomeContreller::class,'storeComment '])->name('frontend.post_comment');
